...
<body bgcolor="white" style="font-family: Arial; background-color:white;">
	...
	<table align="center" bgcolor="#FCFCFC" cellpadding="0" cellspacing="0" class="container" style="line-height: 135%;" width="630">
		...
		<tr>
			<td align="center" bgcolor="#FCFCFC" colspan="3"><img class="header-img" src="<?php echo $message->embed(public_path().'/ix/img/'.'email-header-festival.jpg'); ?>" width="100%"></td>
		</tr>
		<tr>
				...
				<table>
					<tr>
						...
						<td align="left" class="bodyCopy">
							...
							We are pleased to inform that your payment for registration with code <strong>{{$registration->registration_code}}</strong> has been confirmed.<br><br>
							Kindly note that you will be required to mention the booking code during the ticket
							redemption so that it can be exchanged with a bracelet to entry the SPARE XII NEO festival
							area. Don’t forget to download the guidelines here [link]<br><br>
