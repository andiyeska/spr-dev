...
<head>
	...
	<!-- Font Awesome Icon -->
	<link rel="stylesheet" href="/ix/css/font-awesome.min.css">
				...
				<div class="col-md-6 col-md-offset-3">
					<div class="home-content">
						<div class="section-title" style="margin-bottom: -20px;">
							<h1 class="title" style="font-size: 120px;"><span class="gradient">403</span></h1>
						</div>
						<h6 class="lead gradient" style="text-align: center; margin-bottom: 32px; ">we're sorry to say that you <strong>have no access</strong> to this page.</h6>
						<a href="/" class="main-btn center text-center" style="width: 280px; border-radius: 100px;">Return to SPARE</a>
					</div>
				</div>
			</div>
		</div>
